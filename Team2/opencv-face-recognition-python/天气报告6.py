...
bigservocmd='d'
print("send to serial",bigservocmd)
ser.write(bigservocmd.encode())
time.sleep(2)

smallservocmd='2'
print("send to serial",smallservocmd)
ser.write(smallservocmd.encode())
time.sleep(2)
...
#春秋串口发送a，大舵机转，夏发b，冬发d，雨发c
servo0=['a','b','a','d','c']
bigservocmd=servo0[season]
if rain:
    bigservocmd='c'

#发‘1’为田文涛角度0度，发’2‘为马昀菲为90度 发‘3’为贾末为180度
familycmd=['0','1','2','3']
smallservocmd=familycmd[familyID]
